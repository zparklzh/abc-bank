...
public class CustomerTest {
	...
	public void testTransfer() {
		...
		/*
		 * Bill transfer $500 from his checking to his saving account, which means he withdraws $500 
		 * from his checking account and deposit $500 into his saving account
		 */
		...
		assertEquals("Statement for Bill\n" + "\n" + "Checking Account\n" + "  deposit $1,000.00\n"
				+ "  withdrawal $500.00\n" + "Total $500.00\n" + "\n" + "Savings Account\n" + "  deposit $1,000.00\n"
				+ "  deposit $500.00\n" + "Total $1,500.00\n" + "\n" 
				+ "Total In All Accounts $2,000.00", bill.getStatement());
	}
